...
transit location (C2), preserving `unit_cost` and `received_at`.

## Outcomes

- Every [[Stock Movement]] gets unit/total cost (inbound **C1 shipped**; outbound C2)
...
[[Phase C]] — **C1 complete**. C2 + C3 deep plans ready; implement next.
